...
class starter {
	public static void main(String args[]) {
		...
		int inp2 = 0;
		while(inp2<37){
			System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y", inp2));
			System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct", inp2));
			inp2 = inp2 + 1; 
		}
		*/
		...
		System.out.println(Cipher.encode(inp));
		
		
		//System.out.println(Cipher.encode("1 yvo5 v2q9w1"));
